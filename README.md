...
## 2. Get the prebuilt Files from the Repo and Start using it.
...
Confirm the Change: You can verify the new policy by running: >> Get-ExecutionPolicy -List Ensure that the CurrentUser scope is set to RemoteSigned


## 3. MANUAL installation with basic Troubleshooting
Once the required softwares are installed, 
```
npm init -y
